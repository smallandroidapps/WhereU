...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            NotificationHelper.sendLocalNotification(this, title, message, new Intent(this, HomeActivity.class), requestId, senderName);
        } else if (remoteMessage.getNotification() != null) {
            ...
            NotificationHelper.sendLocalNotification(this, title, message, new Intent(this, HomeActivity.class), null, null);
        }
    }
}
