...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appName,
      @NonNull View dot1, @NonNull View dot2, @NonNull View dot3, @NonNull LinearLayout loadingDots,
      @NonNull CardView logoContainer) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout loadingDots = ViewBindings.findChildViewById(rootView, id);
      if (loadingDots == null) {
        break missingId;
      }

      id = R.id.logo_container;
      CardView logoContainer = ViewBindings.findChildViewById(rootView, id);
      if (logoContainer == null) {
        break missingId;
      }

      return new ActivitySplashBinding((ConstraintLayout) rootView, appName, dot1, dot2, dot3,
          loadingDots, logoContainer);
    }
