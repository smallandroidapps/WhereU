...
import com.whereu.whereu.databinding.FragmentPendingRequestsBinding;
...
public class PendingRequestsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewPending.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.recyclerViewPending.setAdapter(requestAdapter);
